            ...
            {[
              ...
              <div key={label as string} style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                ...
                <div style={{ flex: 1, height: '6px', background: '#0c2236', borderRadius: '3px', overflow: 'hidden' }}>
                  <div className="depth-fill" style={{ height: '100%', borderRadius: '3px', width: 0, transition: 'width 1.2s cubic-bezier(.22,1,.36,1)', background: bg as string, ['--w' as any]: w } as React.CSSProperties}/>
                </div>
